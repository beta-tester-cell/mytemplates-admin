            ...
            <tbody>
                <tr>
                    ...
                    <td class="align-center">
                        <a href="#" class="text-secondary" data-toggle="modal" data-target="#EditRencanaPembayaran"><i class="fa fa-edit"></i></a>
                        <a href="#" class="text-danger"><i class="fa fa-eraser"></i></a>
                    </td>
                </tr>
                <tr>
                    <td>2</td>
