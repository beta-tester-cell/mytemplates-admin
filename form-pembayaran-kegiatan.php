                ...
                <div class="card">
                    <div class="d-flex flex-space-between align-center flex-change">
                        ...
                        <div class="d-flex grid-gap-1">
                            <button type="submit" class="btn btn-link btn-secondary  px-20"><i class="fa fa-save"></i> &nbsp;Save</button>
                            <a href="rencana-bayar-kuliah.php" class="btn btn-link btn-primary px-20"><i class="fa fa-plus"></i> &nbsp;New</a>
                        </div>
                    </div>
                </div>
            </div>
