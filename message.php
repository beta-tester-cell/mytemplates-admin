            ...
            <div class="card">
            	<div class="d-flex grid-gap-1">
            		<div class="message-left-side">
            			<button class="btn btn-secondary width-100" id="new-message">New Message <i class="fa fa-plus mx-1"></i></button><hr class="my-1">
            			...
            			<div id="chat001" class="message-display width-100 card" style="display: none;">
							...
							<div class="card-footer message-send width-100">
		                        ...
		                        <button id="send" name="send" class="btn btn-send-second">
			                    	Send <i class="mx-1 fa fa-paper-plane"></i>
			                	</button>
							</div>
            			</div>
            			<!-- END OF EXAMPLE 001 -->
