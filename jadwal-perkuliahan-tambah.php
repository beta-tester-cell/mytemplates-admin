		...
		<div class="form grid-2 grid-gap-1 py-1">
			...
			<div class="card">
				...
				<div class="py-1">
					...
					<div class="form-inputs" style="margin-top:-30px">
						<div class="form grid-1">
							<div class="card">

								<div class="form-inputs">
									<label><font color="grey">Jadwal&nbsp;:</font> </label>
									<label style="margin-left:10px"><font color="grey">3 Total</font></label>
									</div>
						...
						<div class="form grid-1 py-1" style="margin-top:-65px">
							<div class="card">
								<form>
									<div class="form-inputs">
