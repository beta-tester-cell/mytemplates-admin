        ...
        <div class="py-1">
            <div class="card">
                <div class="d-flex flex-start">
                    <a href="form-kalender-akedemik.php" class="btn btn-link">
                        <span><i class=" fa fa-plus"></i> Add New</span>
                    </a>
                    <a href="form-upload-kalender-akedemik.php" class="btn btn-link" style="margin-left: 20px;">
                        <span><i class="fa fa-upload"></i> Upload Kalender</span>
                    </a>
                </div>
            </div>
        </div>
