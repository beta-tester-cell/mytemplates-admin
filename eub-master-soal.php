        ...
        <div class="py-1">
            <div class="card">
                <div class="d-flex grid-gap-2">
                    ...
                    <a href="upload-soal-eub.php" class="btn btn-link"><i class="fa fa-upload"></i> UPLOAD SOAL</a>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-center">
                                        <a href="form-soal-eub.php" title="Edit" class="text-secondary"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <tr>
