                                    ...
                                    <tr>
                                        ...
                                        <td style='vertical-align:top;padding-top:10px; color:white;'>
                                            <table>
                                                ...
                                                <tr>                                                
                                                    <td  style='vertical-align:top;padding-top:2px; color:white;'>
                                                        <font class='font1'>SK. DIKTI No. 158/D/O/2003</font> <br>
                                                    </td>
                                                </tr>
                                                <tr>                                               
                                                    <td  style='vertical-align:top;padding-top:2px; color:white;'>
                                                        <font class='font1'>Kampus Jakarta Pusat (Kramat raya)</font> <br>
                                                    </td>
                                                </tr>
                                                <tr>                                             
                                                    <td  style='vertical-align:top;padding-top:2px; color:white;'>
                                                        <font class='font1'>Gedung Sentra Kramat, Jl. Kramat Raya No 7/9, Jakarta Pusat </font>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style='vertical-align:center; color:white;'>
                                                 <table>
                                                    <tr>
                                                        <td  style='padding-top:2px; color:white;'>
                                                            <font><b>INVOICE DETAIL</b></font><br>
                                                        </td>
                                                    </tr>
                                                    <tr>                                                
                                                        <td  style='padding-top:2px; color:white;'>
                                                             <font>Invoice Number    :  INV/21071110</font> <br>
                                                        </td>
                                                    </tr>
                                                    <tr>                                               
                                                        <td  style='padding-top:2px; color:white;'>
                                                            <font>Account Number  :  071</font> <br>
                                                        </td>
                                                    </tr>
                                                    <tr>                                             
                                                        <td  style='padding-top:2px; color:white;'>
                                                            <font>Invoice Date  : 29/07/2021</font> <br>
                                                        </td>
                                                    </tr>
                                                </table>
                                                </td>
                                ...
                                <tr>
                                    <td style='padding-top:25px;'>
                                         <table>
                                            <tr>
                                                <td>
                                                   <font style='font-size:30px;'><b>PAYMENT</b></font> <br> 
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                   <font style='font-size:15px;'>9881222319888912</font> <br> 
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                   <font style='font-size:15px;'>BNI</font> <br> 
                                                </td>
                                            </tr>
                                    ...
                                    <td>
                                         <table>
                                            <tr>
                                                <td style='padding-top:25px;'>
                                                   <font style='font-size:30px;'><b>BILL TO</b></font> <br> 
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                   <font style='font-size:15px;'>19888912 | ROHIMIN</font> <br> 
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                   <font style='font-size:15px;'>Manajemen Informatika</font> <br> 
                                                </td>
                                            </tr>
                         ...
                         <div style='margin-left:50px;margin-right:50px;'>
                            <table class='table-list' style='border-collapse: collapse;width:100%;margin-top:20px'>
                             ...
                             <table  style='width:100%;margin-top:20px '>
                                ...
                                <tr>
                                    <td width='160px' style='padding-top:60px;'></td>
                                    <td style='text-align:right; padding-right:10px;'><font><b>DISCOUNT</b></font></td>
                                    <td style='text-align:right; padding-right:10px;'><font>0</font></td>
                                </tr>
                            ...
                            <table style='padding-top:50px; '>
                                ...
                                <tr>
                                    <td width='480px'><font><b>Midayanti, SE</b></font></td>
                                </tr>
                                <tr>
                                    <td><font>Kepala Bidang Keuangan</font></td>
                                </tr>
                            </table>
