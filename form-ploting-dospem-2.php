                    ...
                    <div class="form-upload">
                        <form>
                            <div class="form-mr-2 py-1">
                                ...
                                <div class="form-inputs">
                                    <label><b>Dosen Pembimbing 1</b></label>
                                    <select name="dospem_1" id="dospem_1">
                                ...
                                <div class="form-inputs">
                                    <label><b>Dosen Pembimbing 2</b></label>
                                    <select name="dospem_2" id="dospem_2">
                                        <option value="0">-- Pilih Dosen Pembimbing --</option>
                                        <option value="1">Masria, M.Kom</option>
                                        <option value="2">>Nasril, M.Kom</option>
                                        <option value="3" selected>Badriah, M.Ba</option>
                                    </select>
                                </div>
                                <div class="form-inputs">
