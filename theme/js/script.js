...
if(document.getElementById("datatable3")){
    $(document).ready(function(){
...
if(document.getElementById("getRealisasiPembayaran")){
...
// TAGIHAN PEMBAYARAN
if(document.getElementById("getTagihanPembayaran")){
    $(document).ready(function() {
...
// batas
    ...
    // TAGIHAN PEMBIAYAAN
if(document.getElementById("getTagihanPembiayaan")){
    ...
    var lineChart = new Chart(TagihanPembiayaan, {
     ...
     // TAGIHAN PEMBIAYAAN
if(document.getElementById("getRealisasiPembiayaan")){
...
// CHART EWS KRS
if(document.getElementById("getEWSKRS")){
