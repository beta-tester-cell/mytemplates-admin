            ...
            <div class="card">
                <div class="d-flex pb-1 line-bottom-2 flex-change grid-gap-1">
                    ...
                    <div class="d-flex grid-gap-1 flex-reverse-end width-100">
                        <a href="cetak-profit.php" target="_blank" class="btn btn-link btn-primary dropdown-button"><i class="fa fa-print"></i> Print</a>
                ...
                <div class="text-center my-1 line-bottom-1">
                    ...
                    <h6>LABA RUGI</h6>
                    <p style="font-size:16px;">Untuk periode Desember dan periode sampai dengan Desember 2021</p>
                </div>
